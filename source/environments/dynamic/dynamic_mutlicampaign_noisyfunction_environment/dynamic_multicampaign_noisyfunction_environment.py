from source.environments.dynamic.dynamic_mutlicampaign_noisyfunction_environment.__dependencies import *
...
class DynamicMulticampaignNoisyfunctionEnvironment(MulticampaignNoisyfunctionEnvironment):
